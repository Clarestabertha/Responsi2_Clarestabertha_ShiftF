<template>
    <ion-modal :is-open="isOpen" @did-dismiss="cancel">
        ...
        <ion-content>
            <ion-item>
                <ion-input v-model="todo.pahlawan" label="Pahlawan" label-placement="floating"
                    placeholder="Masukkan Nama Pahlawan"></ion-input>
            </ion-item>
            <ion-item>
                <ion-textarea v-model="todo.kisah" label="Kisah" label-placement="floating"
                    placeholder="Masukkan Kisah Perjuangan Pahlawan" :autogrow="true" :rows="3"></ion-textarea>
            </ion-item>
            <ion-row>
                <ion-col>
